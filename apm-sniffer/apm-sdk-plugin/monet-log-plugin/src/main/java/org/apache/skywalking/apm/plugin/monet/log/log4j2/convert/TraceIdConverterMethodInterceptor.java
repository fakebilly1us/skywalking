 ...
 **/
public class TraceIdConverterMethodInterceptor implements InstanceMethodsAroundInterceptorV2 {

    private static final ILog LOGGER = LogManager.getLogger(TraceIdConverterMethodInterceptor.class);
