...
/**
 * ApplicationNameJsonProviderInterceptor
 * @author FakeBilly
 * @version V1.0.0
 * @github https://github.com/fakebilly-dev/skywalking
 **/
public class ApplicationNameJsonProviderInterceptor implements InstanceMethodsAroundInterceptorV2 {

    private static final ILog LOGGER = LogManager.getLogger(ApplicationNameJsonProviderInterceptor.class);
